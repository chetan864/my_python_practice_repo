...
print('git push origin feature/BL-XXX-CK')

print('BL-XXX branch')
print('git merge feature/BL-XXX-CK')
print('git add .')
...
print('git push')
print('git pull origin feature/BL-XXX')
print('git add .')
print('git commit -m "3rd push in BL-XXX-CK branch" ')
print('git push')